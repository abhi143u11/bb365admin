...
(1, 'FREE 165 DOVE 3x100g', 'DOV160', '2021-01-13', 9600, 10, 1, NULL, '1', 1, 1, '1610542182.ic_launcher-png.png', '2021-01-13 07:19:42', '2021-01-13 07:24:47', NULL);
...
CREATE TABLE `notification_message` (
  ...
  `customer_id` int(11) DEFAULT current_timestamp(),
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(2, '161054487267.oreo.webp', 2, '2021-01-13 06:16:15', '2021-01-13 08:04:32'),
...
INSERT INTO `products` (`product_id`, `product_cat_id`, `product_name`, `order_number`, `image`, `mrp`, `quantity`, `min_qty`, `max_qty`, `size`, `featured`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 2, 'Apple', 123, '16105434431.imgbin_apple-juice-fruit-seed-png.png', 1000, 10, 2, 10, '1kg', 1, '2021-01-13 11:55:29', '2021-01-13 07:40:43', NULL),
(2, 2, 'Grapes', 1, '16105434741.grapes-16955.png', 2000, 15, 1, 8, '250ml', 1, '2021-01-13 06:58:11', '2021-01-13 07:41:24', NULL);
...
(2, 'Ramu Bhai', '+918849455420', 'Ramu@gmail.com', 'customer', '1610545474spice.png', NULL, '$2y$10$qVAAwiBHVSc81jQk4Crn6ejOAU.KwnusS3xdzLjUnuAzDmoNplCfu', NULL, '2021-01-13 08:14:34', '2021-01-13 08:14:34', NULL),
...
//13-01-2021
ALTER TABLE `notification_message` CHANGE `customer_id` `customer_id` INT(11) NULL DEFAULT NULL;