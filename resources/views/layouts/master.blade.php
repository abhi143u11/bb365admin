                ...
                <ul class="nav metismenu" id="side-menu">
                    ...
                    <li class="{{'dashboard' == request()->path() ? 'active' : ''}}">
                      ...
                      <li class="{{'imagesnew' == request()->path() ? 'active' : ''}}">
                        <a href="{{url('/imagesnew')}}"><i class="fa fa-th"></i> <span
...
<!-- 
                    ...
                    <li class="{{'transaction' == request()->path() ? 'active' : ''}}">
                        <a href="{{url('/transaction')}}"><i class="fa fa-credit-card-alt"></i> <span
                ...
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    <div class="navbar-header">
                        <a class="navbar-minimalize minimalize-styl-2 btn btn-primary "
                            style="background:#363f50;;color:#fff;border-color:#363f50;" href="#"><i
