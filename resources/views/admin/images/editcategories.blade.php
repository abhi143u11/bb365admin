                    ...
                    <div class="col-md-6">
                        <form action="{{ url('categories-update/' . $categories->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" name="image" id="image" value="{{ $categories->image }}">
                                <label class="custom-file-label" for="image"><b>Choose Image</b></label>
                            </div>

                            <div class="form-group">
                                <label>Name</label>
                                <input type="name" name="name" value="{{ $categories->cat_name }}" class="form-control" id="name" aria-describedby="phoneHelp">
                            </div>
                            <div class="form-group">
                                <label>Order No</label>
                                <input type="text" name="order_no" value="{{ $categories->order_no }}" class="form-control" id="order_no" aria-describedby="phoneHelp">
                            </div>
