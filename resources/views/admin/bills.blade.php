                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-striped" id="bills">
                        ...
                        @foreach ($bills as $bill)
                                ...
                                class="btn-sm btn btn-danger delivered" style="background-color: #363f50 !important; color:black !important"
                                data-toggle="tooltip" data-placement="top"  title="Delivered"><i class="fa fa-truck"></i> </a>
                                @endif
                                ...
                                @if($bill->status!='Delivered' && $bill->status!='Cancel')
                                    ...
                                    @endif
                                        <a href="{{ url('invoice/'.$bill->id) }}"
                                        data-toggle="tooltip" data-placement="top" class="btn-sm btn btn-info" title="Print"><i
